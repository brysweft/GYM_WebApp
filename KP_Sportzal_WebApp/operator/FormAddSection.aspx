<%@ Page Title="Секции" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormAddSection.aspx.cs" Inherits="KP_Sportzal_WebApp.WebForm10" %>
    ...
    <table style="width: 100px"  >
        <tr>
            ...
            <td>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="KP_Sportzal_WebApp.operator.DataSet2TableAdapters.SECTIONSTableAdapter" UpdateMethod="Update">
                    <DeleteParameters>
