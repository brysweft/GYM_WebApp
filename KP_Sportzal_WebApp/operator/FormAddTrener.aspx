<%@ Page Title="Тренеры" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormAddTrener.aspx.cs" Inherits="KP_Sportzal_WebApp.WebForm11" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h3>Тренеры</h3>
    <table style="width: 100px"  >
        <tr>
            <td>
                <asp:Image ID="Image1" runat="server" Height="93px" ImageUrl="~/images/trener.png" Width="115px" />
            </td>
            <td>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="KP_Sportzal_WebApp.operator.DataSet2TableAdapters.TRAINERSTableAdapter" UpdateMethod="Update">
                    <DeleteParameters>
